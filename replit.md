...
- **Admin Dashboard:** Comprehensive management hub featuring:
    ...
    - **Finance Management:** Comprehensive financial operations hub with four-tab navigation for managing billing, payments, and financial insights:
      - **Client Billing (Receivables):** Active talent billing management with columns for Talent Name, Role, Partner, Customer, Month, Working Days, Billable Hours, Amount, GST (18%), Total Amount, Timesheet Status, Invoice Status. Actions include View Breakup (detailed modal), Download Timesheet, Create Invoice & Push to Client. Metrics: Total Amount, Current Receivable, Overdue Amount, Total Invoices. Filters by Partner, Customer, Month, and Status.
      ...
      - **Invoice History:** Historical ledger of all invoices (client and partner) with columns for Invoice Number, Type, Talent, Party, Month, Amount, GST, Total, Issued Date, Paid Date, Status. Actions include View and Download. Metrics: Total Revenue, Total GST Collected, Total Invoices, Paid Invoices. Filters by Month and Status.
      - **Financial Insights:** Dashboard with insight cards for Top Customers by Revenue, Top Partners by Volume, Monthly Trends, and Aging Analysis (0-30 days, 31-60 days, 60+ days overdue). Metrics: Total Receivable, Total Payable, Net Cash Flow, GST Liability. No table view, visualization-focused with metrics cards.
