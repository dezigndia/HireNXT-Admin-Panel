...
- **Admin Dashboard:** Comprehensive management hub featuring:
    ...
    - **Finance Management:** Comprehensive financial operations hub with five-tab navigation for managing billing, payments, reconciliation, revenue analysis, and financial insights. Positioned above Approval Process in sidebar.
      - **Client Billing (Receivables):** Active talent billing management with columns for Talent ID, Talent Name, Role, Partner, Customer, Month, Days, Hrs, Amount, GST (18%), Total Amount, Timesheet Status, Invoice Status. Actions include View Breakup (detailed modal), Download Timesheet, Create Invoice & Push to Client. Metrics: Total Amount, Current Receivable, Overdue Amount, Total Invoices. Filters by Partner, Customer, Month, and Status.
